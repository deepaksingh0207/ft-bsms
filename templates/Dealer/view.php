                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <tr>
                                <?php if($userType == 'buyer') : ?>
                                <table class="table"  id="response_table" class="display nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>RFQ No.</th>
                                        <th>Category</th>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table>
                            ...
                            <tr>
                                <th>Total Value</th>
                                <td><input type="text" class="form-control" name="sub_total" id="sub_total" value="0"  readonly required /></td>
                            </tr>
                            <tr>
                                <th>Delivery Date</th>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><?= $this->Form->button(__('Save'), ['label' => 'Save', 'class' => 'mt-3 btn btn-danger w-100']); ?></td>
                            </tr>
                        </table>
                        <?= $this->Form->end() ?>
                    </div>
