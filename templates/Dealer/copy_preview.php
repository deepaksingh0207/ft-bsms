    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex">
                <div class="col-8">
                    <h4 class="mb-0">Request for Quotation</h4>
                    <?= $this->Flash->render('auth') ?>
                    <?= $this->Form->create($rfqDetail) ?>
                </div>
                <div class="col-4">
                <button label="Login" class="float-right btn btn-info button button-rounded button-reveal button-large button-red text-end bin"
                    type="button" onclick="deleteform()" style="display:none;">
                    <i class="icon-line2-trash"></i>
                    <span>DELETE</span>
                </button>
                <button label="Login" class="mr-2 float-right btn btn-info button button-rounded button-reveal button-large button-purple"
                    type="button" onclick="addform()">
                    <i class="icon-line-plus"></i>
                    <span>ADD</span>
                </button>
                <button label="Login"
                    class="mr-2 btn btn-info float-right button button-rounded button-reveal button-large button-yellow button-light text-end"
            ...
            <div class="card-body pt-0" id="mulform">
                <?php
                $cnt = 0;
...
<script>
    ...
    function addrow(id) {
        $("#mulform").prepend(`<div class="row" id="RFQ` + (id) + `">
                            <div class="col-12">
                            <h5 class="pt-3"><b>PRODUCT `+ (id + 1) + ` </b></h5>
                            </div>
                            <div class="col-4">
