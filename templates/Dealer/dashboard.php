        ...
        <ul class="products-list product-list-in-card pl-2 pr-2">
          ...
          <li class="item">
            ...
            <div class="product-info" style="font-size: smaller;">
              <a href="javascript:void(0)" class="product-title"><?=ucfirst($status) ?>
                <span class="badge badge-warning float-right"><?=$count ?></span></a>
            </div>
          </li>
          <?php endforeach; ?>
        </ul>
    ...
    <div class="card">
      ...
      <div class="card-body p-0">
        ...
        <?php foreach($supplierCount as $status => $count) : ?>
          <li class="item">
            <div class="product-img">
              <img src="<?= $this->Url->build('/') ?>/img/edi.png" alt="Product Image" class="" style="width: 2vw;height: auto;">
            </div>
            <div class="product-info" style="font-size: smaller;">
